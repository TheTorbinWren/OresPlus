...
public class OldTileEntityGrinder 
extends OldTileEntityMachine {
	
	public OldTileEntityGrinder() {
		super(1200);
	...
	private void grindItem() {
		if (!this.hasWork())
			return;
		ItemStack item = Ores.grinderRecipes.getResult(this.currentItem);
	...
	public boolean hasWork() {
		...
		ItemStack item = Ores.grinderRecipes.getResult(this.currentItem != null ? this.currentItem : this.inventory[0]);
		if (item == null) {
			return false;
		}
		if (this.inventory[2] == null) {
